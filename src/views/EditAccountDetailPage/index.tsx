        ...
        <div id="account-edit-page">
            ...
            <div className="page-header">
                ...
                <div className="page-button-wrap">
                    <div id="account-edit-cancel-button" className="button__base" data-l10n="ACCOUNT_EDIT_CANCEL_BUTTON"
                        onClick={backToDetail}>
                        Cancel edition1111
                    </div>
                    <div id="account-edit-confirm-button" className="button__base" data-l10n="ACCOUNT_EDIT_CONFIRM_BUTTON">
                        Confirm edition1111
                    </div>
                </div>
            </div >
                        ...
                        <div className="past-passwords">
                            ...
                            <div className="past-passwords-list">
                                <div className="account-field">
                                    ...
                                    <div className="password-delete-button.button__base">删除</div>
                                </div>
                                <div className="past-password-add-button.button__base">
                                    <PlusIcon />
                                </div>
                            </div>
                        </div>
                ...
                <div className="account-protection-part">
                    ...
                    <div className="account-protection-list">
                        <div className="account-protection-item">
                            ...
                            <div className="protection-delete-button.button__base">删除</div>
                        </div>
                        <div className="protection-add-button.button__base">
                            <PlusIcon />
                        </div>
                    </div>
                </div>
